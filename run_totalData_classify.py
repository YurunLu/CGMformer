...
# Zhao classifier checkpoint
zhao_macrovascular_classify_checkpoint_path = "/share/home/liangzhongming/930/CGMformer/downStreamOutput/1028/97_ZhaoCV2_macrovascular_mean_F0_231108_231029_020352_dim128_97_TFIDF_L4_H8_emb128_SL97_E3000_B48_LR0.0004_LSlinear_WU2000_Oadamw_DS2_L289_B12_LR4e-05_LScosine_WU100_E20_Oadamw_F0/checkpoint-198"
zhao_microvascular_classify_checkpoint_path = "/share/home/liangzhongming/930/CGMformer/downStreamOutput/1028/97_ZhaoCV4_microvascular_mean_F0_231108_231029_020352_dim128_97_TFIDF_L4_H8_emb128_SL97_E3000_B48_LR0.0004_LSlinear_WU2000_Oadamw_DS2_L289_B12_LR4e-05_LScosine_WU100_E20_Oadamw_F0/checkpoint-280"
zhao_complication_classify_checkpoint_path = "/share/home/liangzhongming/930/CGMformer/downStreamOutput/1028/97_ZhaoCV2_complication_mean_F0_231108_231029_020352_dim128_97_TFIDF_L4_H8_emb128_SL97_E3000_B48_LR0.0004_LSlinear_WU2000_Oadamw_DS2_L289_B12_LR4e-05_LScosine_WU100_E20_Oadamw_F0/checkpoint-189"
# zhao_T2D_classify_checkpoint_path = "/share/home/liangzhongming/930/CGMformer/downStreamOutput/1028/97_ZhaoCV4_T2D_mean_F0_231109_231029_020352_dim128_97_TFIDF_L4_H8_emb128_SL97_E3000_B48_LR0.0004_LSlinear_WU2000_Oadamw_DS2_L97_B12_LR0.0004_LScosine_WU100_E20_Oadamw_F0/checkpoint-800"
zhao_T2D_classify_checkpoint_path = "/share/home/liangzhongming/930/CGMformer/downStreamOutput/1028/97_ZhaoCV4_T2D_mean_F0_231109_231029_020352_dim128_97_TFIDF_L4_H8_emb128_SL97_E3000_B48_LR0.0004_LSlinear_WU2000_Oadamw_DS2_L97_B12_LR0.0004_LScosine_WU100_E20_Oadamw_F0/checkpoint-112"
...
# total_dataset = "/share/home/liangzhongming/930/CGMformer/data/Data_downstream/Colas_1028_hfds"
zhao_total_dataset = "/share/home/liangzhongming/930/CGMformer/data/Data_downstream/Zhao_total"
zhao1017_total_dataset = "/share/home/liangzhongming/930/CGMformer/data/Data_downstream/1017_Zhao_total"
...
# totalData = load_from_disk(total_dataset)
zhao_totalData = load_from_disk(zhao1017_total_dataset)

# rename columns
# totalData = totalData.rename_column("types", "label")
# zhao_totalData = zhao_totalData.rename_column("macrovascular ", "label")
# zhao_totalData = zhao_totalData.rename_column("microvascular", "label")
# zhao_totalData = zhao_totalData.rename_column("complication", "label")
zhao_totalData = zhao_totalData.rename_column("types", "label")
...
# zhao
# target_names = {'0', '1'}
# target_name_id_dict = {0: 0, 1: 1}
target_names = {'T1D', 'T2D'}
target_name_id_dict = {'T1D': 1, 'T2D': 0}

# For the Colas dataset, this needs to correspond to the classifier checkpoint
...
labeled_totalData = zhao_totalData.map(classes_to_ids, num_proc=16)
...
model = BertForSequenceClassification.from_pretrained(
    ...
    zhao_T2D_classify_checkpoint_path,
    num_labels=len(subtask_label_dict.keys()), # Colas + 1
    output_attentions=False,
    output_hidden_states=False, # False->True
    ignore_mismatched_sizes=True, # Ignore parameter size mismatch
).to("cuda")
...
decs = "Zhao1017_1109_T2D_total_ckp112"
current_date = datetime.datetime.now()
datestamp = f"{str(current_date.year)[-2:]}{current_date.month:02d}{current_date.day:02d}"
# output_dir = output_path + f"/{decs}_{datestamp}_{zhao_macrovascular_classify_checkpoint_path.split('/')[-2]}_L{max_input_size}_B{batch_size}_LR{max_lr}_LS{lr_schedule_fn}_WU{warmup_steps}_E{epochs}_O{optimizer}_F{freeze_layers}/"
output_dir = output_path + f"/{decs}_{datestamp}_L{max_input_size}_B{batch_size}_LR{max_lr}_LS{lr_schedule_fn}_WU{warmup_steps}_E{epochs}_O{optimizer}_F{freeze_layers}/"
